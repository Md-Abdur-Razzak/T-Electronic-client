...
const Contack = () => {
    return (
        <div className='w-full  p-12 bg-[#14114106] mt-9'>
            <h1 className='flex justify-center text-4xl font-extrabold pb-12'>Contact <span className='ml-3 text-blue-500'>Us</span></h1>
           <div className='lg:w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-3 md:mt-0 mt-9'>
                <div className='mt-2 lg:block flex flex-wrap gap-3 justify-center'>
                    <div className=' bg-[#0d102ed2] text-white w-[250px] rounded-md p-4'>
                        <h1 className='font-bold'><i class="fa-solid fa-location-dot"></i>  Office Location</h1>
                        <h1>2rd floor,Bashundhara Road</h1>
                    </div >
                    <div className=' bg-[#0d102ed2] text-white w-[250px] rounded-md mt-3 p-4'>
                       <h1 className='font-bold'><i class="fa-solid fa-phone"></i> Contact No </h1>
                       <h1>+88 01701811157 </h1>

                    </div>
                    <div className=' bg-[#0d102ed2]  font-bold text-white mt-3 w-[250px] rounded-md p-4'>
                        <h1 className='font-bold'> <i class="fa-solid fa-envelope "></i><span> Email</span></h1>
