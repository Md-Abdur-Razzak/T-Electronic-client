    ...
    <div className="card flex-shrink-0 w-full  shadow-2xl bg-base-100">
      <form onSubmit={handelAddData} className="card-body">
       ...
       <div className="form-control">
          ...
          <input type="text" placeholder="price" name='pPrice' className="input input-bordered" required />
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text">Details</span>
          </label>
          <input type="text" placeholder="Product Details" name='pDetails' className="input input-bordered" required />
       ...
       <div className="form-control">
          ...
          <input type="text" placeholder="Product Type" name='typesofproducts' className="input input-bordered" required />
        </div>
        <div className="form-control">
          <label className="label">
